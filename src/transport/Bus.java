...
public class Bus extends Car implements Competing {
    ...
    private String startMoving;
    private String finishMovement;
    private OptionalDataException competingCommands;


    public Bus(String brand, String model, double engineCapacity, int maximumMovementSpeed) {
        super(brand, model, engineCapacity, maximumMovementSpeed);
        this.brand = brand;
        this.model = model;
        this.engineCapacity = engineCapacity;
        this.maxSpeed = maximumMovementSpeed;
    }
    ...
    public String toString() {
        ...
        return "Bus={Марка: " + brand + ", Модель: " + model + ", Объем: " + engineCapacity
